...
(function (h) {
    ...
    function nb(a) {
        ...
        for (
            var f = a.sDom.split(""), g, j, i, n, l, q, t = 0;
            t < f.length;
            t++
        ) {
            g = null;
        ...
        if (a.scrollBarVis !== v && a.scrollBarVis !== k)
            ...
            if (F.outerWidth() < f) {
                ...
                if (
                    ...
                    r.width = x(P - b);
                ("" === c || "" !== d) &&
                    L(a, 1, "Possible column misalignment", 6);
            } else P = "100%";
            q.width = x(P);
            g.width = x(P);
    ...
    function va(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            ...
            for (f = b.length; e < f; e++)
                (g = b[e].src),
                    h(G(a.aoData, "anCells", g)).removeClass(
                        c + (2 > e ? e + 1 : 3)
                    );
            e = 0;
            for (f = d.length; e < f; e++)
                (g = d[e].src),
                    h(G(a.aoData, "anCells", g)).addClass(
                        c + (2 > e ? e + 1 : 3)
                    );
        }
        a.aLastSort = d;
        ...
        if (a.oFeatures.bStateSave) {
            ...
            if (
                ...
                for (c = e.columns.length; b < c; b++) {
                    ...
                    f.search !== k &&
                        h.extend(a.aoPreSearchCols[b], Bb(f.search));
                }
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    z(
                        ...
                        "aoDrawCallback",
                        function () {
                            (o.bSorted || y(o) === "ssp" || w.bDeferRender) &&
                                va(o);
                        },
                        "sc"
                    );
                    ...
                    0 === j.length || 0 === j.children().length
                        ...
                        : 0 < j.length &&
                          ((o.nTFoot = j[0]), da(o.aoFooter, o.nTFoot));
                    if (e.aaData)
                    ...
                    if (h.isArray(a) || a instanceof h)
                        ...
                        a.nodeName && "tr" === a.nodeName.toLowerCase()
                            ...
                            : ((c = h("<tr><td/></tr>").addClass(b)),
                              (h("td", c).addClass(b).html(a)[0].colSpan = aa(
                                  d
                              )),
                              e.push(c[0]));
                };
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo:
                "Hiển thị từ _START_ đến _END_ trong tổng số  _TOTAL_ dữ liệu",
            sInfoEmpty: "Hiển thị tổng số 0 dữ liệu",
            sInfoFiltered: "(đã lọc _MAX_ trong tổng số dữ liệu)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Không có dữ liệu nào được tìm thấy!",
        },
